            ...
            <div className="flex gap-2">
                ...
                <div className="flex flex-col">
                    <div className="flex items-center gap-1">
                        <p>{card.name}</p>
                        <svg
  className="mt-0.5 w-3 h-3 text-green-500"
  viewBox="0 0 12 12"
...
>
            ...
            <div className="flex items-center justify-between text-slate-500 text-xs">
                <div className="flex items-center gap-1">
                    ...
                    <a href="https://x.com" target="_blank" className="hover:text-sky-500">
                        <svg width="11" height="10" className="fill-green-600" viewBox="0 0 11 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="m.027 0 4.247 5.516L0 10h.962l3.742-3.926L7.727 10H11L6.514 4.174 10.492 0H9.53L6.084 3.616 3.3 0zM1.44.688h1.504l6.64 8.624H8.082z" fill="green" />
                        </svg>
                    </a>
                </div>
                <p>{card.date}</p>
  ...
  <div className="flex items-center  gap-2  mb-7 text-sm text-green-600 justify-center w-full md:w-1/2 lg:w-1/5 bg-green-400/10 rounded-full px-6 py-1.5 ">
        ...
        <Title title="Don't just take our words" description="See what our users have to say about their experience with our platform." />
    </div>
